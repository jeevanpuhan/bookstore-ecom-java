...
public class User {
	...
	public String toString() {
		return String.format(
				"User [userId=%s, userName=%s, userEmail=%s, userPassword=%s, userPhone=%s, userPic=%s, userAddress=%s]",
				userId, userName, userEmail, userPassword, userPhone, userPic, userAddress);
	}
